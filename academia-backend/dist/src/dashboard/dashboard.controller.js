...
let DashboardController = class DashboardController {
    dashboardService_ahbb;
    constructor(dashboardService_ahbb) {
        this.dashboardService_ahbb = dashboardService_ahbb;
    }
    async obtenerEstadisticas_ahbb(request_ahbb) {
        return this.dashboardService_ahbb.getDashboardStats_ahbb(Number(request_ahbb.usuario_ahbb?.sub), request_ahbb.usuario_ahbb?.rol || '');
    }
};
...
], DashboardController.prototype, "obtenerEstadisticas_ahbb", null);
