...
import { obtenerMenuPorRol_ahbb, type IEnlaceMenu_ahbb } from './constantes/menuSistema_ahbb';
 ...
 */
const enlacesMenu_ahbb = computed<IEnlaceMenu_ahbb[]>(() => {
  const rol_ahbb = authStore_ahbb.usuarioActivo_ahbb?.rol as TipoRol_ahbb | undefined;
  if (!rol_ahbb) return [];
 ...
 */
const colorRol_ahbb = computed<string>(() => {
 ...
 */
const etiquetaRol_ahbb = computed<string>(() => {
  const rol_ahbb = authStore_ahbb.usuarioActivo_ahbb?.rol;
