...
import type { IOpcionSelect, EstatusCurso } from '../../types';
...
const manejarBusqueda_ahbb = (valor_ahbb: string | number | null): void => {
  cursosStore_ahbb.buscar_ahbb(String(valor_ahbb ?? ''));
};

const manejarFiltro_ahbb = (valor_ahbb: EstatusCurso | 'todos'): void => {
