...
const diasFormateados_ahbb = computed<string>(() => {
...
const nombrePrelacion_ahbb = computed<string>(() => {
...
const colorEstatus_ahbb = computed<string>(() => {
  const m: Record<EstatusCurso, string> = {
    activo: 'positive',
    pendiente: 'warning',
    inactivo: 'negative',
  };
