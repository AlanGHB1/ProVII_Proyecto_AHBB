<!--
  ...
  Muestra información adicional sobre la calidad del merch,
  producción local y opciones de personalización.
  Layout de 2 columnas: imagen + lista de detalles.
-->
<script setup>
/**
 * listaDetalles_ah — Puntos destacados sobre la calidad y producción
 * Cada detalle tiene un ícono, título y descripción
 */
...
<style scoped>
/* ========================
   Estilos Detalles Adicionales _ah
   ======================== */
...
/* Item individual con ícono y texto */
.detalle-item_ah {
  display: flex;
