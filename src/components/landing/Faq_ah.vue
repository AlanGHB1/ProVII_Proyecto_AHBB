<!--
  ...
  Cada pregunta se expande/contrae al hacer clic.
  Reduce la fricción antes de la compra.
-->
<script setup>
import { ref } from "vue";

/**
 * preguntasFrecuentes_ah — Arreglo de preguntas y respuestas del FAQ
 */
 ...
 * @param {number} indice - Índice de la pregunta a alternar
 */
...
/* Estilo cuando el item está activo/expandido */
.faq-item-activo_ah {
...
/* Rotación del ícono cuando está activo (+ se convierte en x visual) */
.faq-icono-rotado_ah {
...
/* Respuesta visible con altura automática */
