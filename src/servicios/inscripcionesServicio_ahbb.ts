/**
 * inscripcionesServicio_ahbb.ts — Servicio de inscripciones
...
const leerInscripcionesLS_ahbb = (): IInscripcion_ahbb[] =>
  obtenerDato_ahbb<IInscripcion_ahbb[]>(CLAVE_LS_AHBB, []);

const guardarInscripcionesLS_ahbb = (inscripciones_ahbb: IInscripcion_ahbb[]): void =>
  guardarDato_ahbb<IInscripcion_ahbb[]>(CLAVE_LS_AHBB, inscripciones_ahbb);
 ...
 */
export const obtenerInscripciones_ahbb = async (): Promise<IInscripcion_ahbb[]> => {
  if (MODO_API_AHBB) {
    const respuesta_ahbb = await apiCliente_ahbb.get<IInscripcion_ahbb[]>('/inscripciones');
 ...
 */
export const obtenerInscripcionesPorAlumno_ahbb = async (
  alumnoId_ahbb: string,
): Promise<IInscripcion_ahbb[]> => {
  if (MODO_API_AHBB) {
    const respuesta_ahbb = await apiCliente_ahbb.get<IInscripcion_ahbb[]>(
 ...
 */
export const obtenerInscripcionesPorCurso_ahbb = async (
  cursoId_ahbb: string,
): Promise<IInscripcion_ahbb[]> => {
  if (MODO_API_AHBB) {
    const respuesta_ahbb = await apiCliente_ahbb.get<IInscripcion_ahbb[]>(
 ...
 */
export const crearInscripcion_ahbb = async (
  datos_ahbb: IInscripcionFormulario_ahbb,
): Promise<{ exito: boolean; inscripcion: IInscripcion_ahbb | null; mensaje: string }> => {
  if (MODO_API_AHBB) {
    try {
      const respuesta_ahbb = await apiCliente_ahbb.post<IInscripcion_ahbb>('/inscripciones', datos_ahbb);
  ...
  const nuevaInscripcion_ahbb: IInscripcion_ahbb = {
    id: generarId_ahbb(),
...
export const actualizarEstadoInscripcion_ahbb = async (
  inscripcionId_ahbb: string,
  nuevoEstado_ahbb: TipoEstadoAcademico_ahbb,
