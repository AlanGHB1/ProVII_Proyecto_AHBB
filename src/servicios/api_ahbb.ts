/**
 * api_ahbb.ts — Instancia central de Axios y configuración del modo de datos
 *
 ...
 * Cuando migremos a API real, el token se leerá de donde
 * se almacene (cookie, localStorage, etc.).
 */
