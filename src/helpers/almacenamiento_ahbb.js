 ...
 * @param {string} clave_ahbb - Clave del item en LocalStorage
 * @param {*} valorPorDefecto_ahbb - Valor por defecto si no existe
 * @returns {*} El valor parseado o el valor por defecto
 */
export const obtenerDato_ahbb = (clave_ahbb, valorPorDefecto_ahbb = null) => {
  try {
 ...
 * @param {string} clave_ahbb - Clave del item
...
export const guardarDato_ahbb = (clave_ahbb, valor_ahbb) => {
  try {
    ...
    console.error(`Error al guardar "${clave_ahbb}" en LocalStorage:`, error_ahbb);
  }
};

/**
 * Elimina un item del LocalStorage.
 * @param {string} clave_ahbb - Clave del item a eliminar
 */
export const eliminarDato_ahbb = (clave_ahbb) => {
  try {
    localStorage.removeItem(clave_ahbb);
  } catch (error_ahbb) {
    console.error(`Error al eliminar "${clave_ahbb}" de LocalStorage:`, error_ahbb);
  }
};
